...
# #     extract_robot_data,
# #     check_robot_data, abstract_plan
# # )
# # import pandas as pd
# # import random
# # import time
...
# # def receive_data():
# #     global initial_data, current_robot_states, first_json_received, index_value, processed_hmm_arrays
...
# #     # Update previous and current abstracted plans
# #     previous_abstracted_plan = current_robot_states["robots"][str(robot_number)]["currentAbstractedPlan"]
# #     current_robot_states["robots"][str(robot_number)]["currentAbstractedPlan"] = current_abstracted_plan

# #     print("previous_abstracted_plan",previous_abstracted_plan)
# #     print("current_abstracted_plan",current_abstracted_plan)
...
#         "robots": {
#             robot_id: {
#                 "currentLocationPlan": current_robot_states["robots"][robot_id]["currentLocationPlan"],
#                 "currentAbstractedPlan": current_robot_states["robots"][robot_id]["currentAbstractedPlan"],
#             } for robot_id in current_robot_states["robots"]
#         }
#     }
...
#         previous_location_plan = previous_robot_states["robots"][robot_number]["currentLocationPlan"]
#         previous_abstracted_plan = previous_robot_states["robots"][robot_number]["currentAbstractedPlan"]
