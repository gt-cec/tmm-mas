...
# has the study table sequence abstracted from Dani's table. 1 to 24 count recorded and when 25 hits, it gets reset and the study starts at 1. no randomization.
...
# --- MODIFIED update_simulation_views (only to fix logging context) ---
@app.callback(
...
.message-container-details.new-message {
    ...
    app.run(debug=False, host='0.0.0.0', port=1047)