        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Robot 2 is experiencing poor weather, Robot 3 is experiencing rough terrain " # Assuming this was the intended non-duplicate
                ]
            },
            {
...
# --- MODIFIED: start_study now directs to consent_screen ---
@app.callback(
...
@app.callback(
    ...
    State('study-state-store', 'data'),
    State('participant-store', 'data'),
    # Note: Removed State('scenario-data-store', 'data') here as it causes the NameError when data is loading.
    # The necessary data will be loaded within the function context if the phase is 'simulation'.
    prevent_initial_call=True
)
...
""")
    ...
    app.run(debug=False, host='0.0.0.0', port=9562)
    # server = app.server