...
class Metaclass_AgentPoses(type):
    """Metaclass of message 'AgentPoses'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_hmm_sim.msg.AgentPoses')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__agent_poses
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__agent_poses
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__agent_poses
            cls._TYPE_SUPPORT = module.type_support_msg__msg__agent_poses
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__agent_poses
...
class AgentPoses(metaclass=Metaclass_AgentPoses):
    """Message class 'AgentPoses'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.agents = array.array('i', kwargs.get('agents', []))
    ...
    def agents(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'agents' array.array() must have the type code of 'i'"
            self._agents = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'agents' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._agents = array.array('i', value)
