...
#include "interfaces_hmm_sim/msg/detail/agent_poses__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: agents
  {
    ...
    size_t item_size = sizeof(ros_message.agents[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_hmm_sim::msg::AgentPoses;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const interfaces_hmm_sim::msg::AgentPoses *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_hmm_sim::msg::AgentPoses *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AgentPoses__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_hmm_sim::msg::AgentPoses *>(
...
static size_t _AgentPoses__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AgentPoses(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AgentPoses__callbacks = {
...
static rosidl_message_type_support_t _AgentPoses__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AgentPoses__callbacks,
...
{
  return &interfaces_hmm_sim::msg::typesupport_fastrtps_cpp::_AgentPoses__handle;
}
