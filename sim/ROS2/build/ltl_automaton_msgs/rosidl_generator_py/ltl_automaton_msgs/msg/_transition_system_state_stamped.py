...
class Metaclass_TransitionSystemStateStamped(type):
    """Metaclass of message 'TransitionSystemStateStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__transition_system_state_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__transition_system_state_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__transition_system_state_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__transition_system_state_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__transition_system_state_stamped
...
class TransitionSystemStateStamped(metaclass=Metaclass_TransitionSystemStateStamped):
    """Message class 'TransitionSystemStateStamped'."""
