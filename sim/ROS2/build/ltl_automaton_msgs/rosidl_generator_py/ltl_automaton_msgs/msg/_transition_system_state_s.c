...
bool ltl_automaton_msgs__msg__transition_system_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ltl_automaton_msgs.msg._transition_system_state.TransitionSystemState", full_classname_dest, 69) == 0);
  }
  ltl_automaton_msgs__msg__TransitionSystemState * ros_message = _ros_message;
  {  // states
  ...
  {  // state_dimension_names
    PyObject * field = PyObject_GetAttrString(_pymsg, "state_dimension_names");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'state_dimension_names'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->state_dimension_names.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of TransitionSystemState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ltl_automaton_msgs.msg._transition_system_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TransitionSystemState");
  ...
  {  // state_dimension_names
    ...
    rosidl_runtime_c__String * src = ros_message->state_dimension_names.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "state_dimension_names", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
