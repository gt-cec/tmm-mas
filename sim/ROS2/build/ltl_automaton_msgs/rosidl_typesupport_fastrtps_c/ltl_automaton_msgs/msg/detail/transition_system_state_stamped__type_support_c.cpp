...
#include "ltl_automaton_msgs/msg/detail/transition_system_state_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _TransitionSystemStateStamped__ros_msg_type = ltl_automaton_msgs__msg__TransitionSystemStateStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TransitionSystemStateStamped__ros_msg_type * ros_message = static_cast<const _TransitionSystemStateStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TransitionSystemStateStamped__ros_msg_type * ros_message = static_cast<_TransitionSystemStateStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ltl_automaton_msgs__msg__TransitionSystemStateStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TransitionSystemStateStamped__ros_msg_type * ros_message = static_cast<const _TransitionSystemStateStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TransitionSystemStateStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ltl_automaton_msgs__msg__TransitionSystemStateStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ltl_automaton_msgs
size_t max_serialized_size_ltl_automaton_msgs__msg__TransitionSystemStateStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ltl_automaton_msgs__msg__TransitionSystemStateStamped;
    is_plain =
      (
...
static size_t _TransitionSystemStateStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ltl_automaton_msgs__msg__TransitionSystemStateStamped(
...
static message_type_support_callbacks_t __callbacks_TransitionSystemStateStamped = {
...
static rosidl_message_type_support_t _TransitionSystemStateStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TransitionSystemStateStamped,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ltl_automaton_msgs, msg, TransitionSystemStateStamped)() {
  return &_TransitionSystemStateStamped__type_support;
}
