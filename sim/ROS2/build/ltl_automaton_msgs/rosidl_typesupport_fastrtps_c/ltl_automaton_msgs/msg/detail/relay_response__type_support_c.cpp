...
#include "ltl_automaton_msgs/msg/detail/relay_response__rosidl_typesupport_fastrtps_c.h"
...
using _RelayResponse__ros_msg_type = ltl_automaton_msgs__msg__RelayResponse;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RelayResponse__ros_msg_type * ros_message = static_cast<const _RelayResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RelayResponse__ros_msg_type * ros_message = static_cast<_RelayResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_ltl_automaton_msgs__msg__RelayResponse(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RelayResponse__ros_msg_type * ros_message = static_cast<const _RelayResponse__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RelayResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ltl_automaton_msgs__msg__RelayResponse(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ltl_automaton_msgs
size_t max_serialized_size_ltl_automaton_msgs__msg__RelayResponse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ltl_automaton_msgs__msg__RelayResponse;
    is_plain =
      (
...
static size_t _RelayResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ltl_automaton_msgs__msg__RelayResponse(
...
static message_type_support_callbacks_t __callbacks_RelayResponse = {
...
static rosidl_message_type_support_t _RelayResponse__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RelayResponse,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ltl_automaton_msgs, msg, RelayResponse)() {
  return &_RelayResponse__type_support;
}
