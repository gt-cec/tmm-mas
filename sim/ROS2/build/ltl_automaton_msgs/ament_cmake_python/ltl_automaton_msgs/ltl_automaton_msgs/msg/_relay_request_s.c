...
bool ltl_automaton_msgs__msg__relay_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ltl_automaton_msgs.msg._relay_request.RelayRequest", full_classname_dest, 50) == 0);
  }
  ltl_automaton_msgs__msg__RelayRequest * ros_message = _ros_message;
  {  // from_pose
    PyObject * field = PyObject_GetAttrString(_pymsg, "from_pose");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->from_pose.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'from_pose'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // to_pose
    PyObject * field = PyObject_GetAttrString(_pymsg, "to_pose");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->to_pose.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'to_pose'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of RelayRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ltl_automaton_msgs.msg._relay_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelayRequest");
  ...
  {  // from_pose
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "from_pose");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->from_pose.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->from_pose.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->from_pose.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // to_pose
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "to_pose");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->to_pose.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->to_pose.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->to_pose.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
