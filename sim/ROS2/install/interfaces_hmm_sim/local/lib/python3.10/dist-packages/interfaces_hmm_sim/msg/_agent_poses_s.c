...
bool interfaces_hmm_sim__msg__agent_poses__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_hmm_sim.msg._agent_poses.AgentPoses", full_classname_dest, 46) == 0);
  }
  interfaces_hmm_sim__msg__AgentPoses * ros_message = _ros_message;
  {  // agents
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->agents.data;
...
{
  /* NOTE(esteve): Call constructor of AgentPoses */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_hmm_sim.msg._agent_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgentPoses");
  ...
  {  // agents
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "agents");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->agents.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->agents.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->agents.size * sizeof(int32_t));
      assert(data != NULL);
