...
bool ltl_automaton_msgs__srv__task_replanning_relabel__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ltl_automaton_msgs.srv._task_replanning_relabel.TaskReplanningRelabel_Request", full_classname_dest, 77) == 0);
  }
  ltl_automaton_msgs__srv__TaskReplanningRelabel_Request * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of TaskReplanningRelabel_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ltl_automaton_msgs.srv._task_replanning_relabel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskReplanningRelabel_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ltl_automaton_msgs__srv__task_replanning_relabel__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ltl_automaton_msgs.srv._task_replanning_relabel.TaskReplanningRelabel_Response", full_classname_dest, 78) == 0);
  }
  ltl_automaton_msgs__srv__TaskReplanningRelabel_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // new_plan
    ...
    if (!ltl_automaton_msgs__msg__ltl_plan__convert_from_py(field, &ros_message->new_plan)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TaskReplanningRelabel_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ltl_automaton_msgs.srv._task_replanning_relabel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskReplanningRelabel_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // new_plan
    PyObject * field = NULL;
    field = ltl_automaton_msgs__msg__ltl_plan__convert_to_py(&ros_message->new_plan);
    if (!field) {
      return NULL;
    }
    {
